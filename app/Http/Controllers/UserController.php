...
public function userfeedback(Request $request){
    ...
    public function getUserFeedback(){
        ...
        return view('admin.user_feedbacks.feedback',compact('feedbacks'));
    }
    public function viewUserFeedback(Request $request){
        
        $feedback = UserFeedback::findOrFail($request->id);
        // dd($feedback);
        if ($feedback) {
            return response()->json([
                'success' => true,
